...
export default async function ShopRegionPlansPage({
  params,
  searchParams,
}: {
  ...
  // Anonymous plan comparison must stay available when auth is
  // unavailable; checkout still validates at its own API boundary.
  let user: Awaited<
    ReturnType<
